...
const MAP_MODS = [
  ...
  { ids: ["explicit.stat_1106651798", "explicit.stat_798009319", "explicit.stat_798009319"], regex: "속도가", group: "몬스터 강화", affix: "폭주", text: "몬스터 도발 면역\n몬스터의 동작 속도가 기본 수치 밑으로 내려가지 않음\n몬스터의 이동 속도가 기본 수치 밑으로 내려가지 않음" },
  ...
  { ids: ["explicit.stat_95249895", "explicit.stat_1041951480"], regex: "기절.면", group: "몬스터 강화", affix: "변함없는", text: "몬스터의 생명력 (25—30)% 증폭\n몬스터 기절 면역\n몬스터의 생명력 (40—49)% 증폭" },

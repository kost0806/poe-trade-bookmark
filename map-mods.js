...
const MAP_MODS = [
  ...
  { ids: ["explicit.stat_3448216135"], regex: "를.냉", group: "몬스터 강화", affix: "동결의", text: "몬스터가 (90—110)%의 추가 물리 피해를 냉기 속성으로 가함" },
  { ids: ["explicit.stat_3416853625"], regex: "를.번", group: "몬스터 강화", affix: "감전의", text: "몬스터가 (90—110)%의 추가 물리 피해를 번개 속성으로 가함" },
  { ids: ["explicit.stat_1497673356"], regex: "를.화", group: "몬스터 강화", affix: "불타는", text: "몬스터가 (90—110)%의 추가 물리 피해를 화염 속성으로 가함" },
  { ids: ["explicit.stat_144665660"], regex: "출혈", group: "몬스터 강화", affix: "뚫리지 않는", text: "몬스터가 50%의 확률로 중독, 꿰뚫기, 출혈 회피" },
  { ids: ["explicit.stat_322206271"], regex: "긴급", group: "몬스터 강화", affix: "- 절연", text: "몬스터가 70%의 확률로 원소 상태 이상 긴급회피" },
  { ids: ["explicit.stat_4164174520"], regex: "힘줄", group: "몬스터 강화", affix: "- 살육", text: "몬스터가 공격 명중 시 힘줄 절단 유발" },
  { ids: ["explicit.stat_2553656203"], regex: "점화,", group: "몬스터 강화", affix: "강화된", text: "몬스터가 명중 시 20%의 확률로 점화, 동결, 감전 유발" },

 ...
 *
 * regex 값은 지도 모드 전체를 대상으로 '이 모드에만 매칭되는 최단 부분문자열'로
 * 계산했고, 80개 전부 유일성을 검증했다. 값이 바뀌는 숫자 구간은 제외했다.
 * ids가 여러 개인 항목은 값만 다른 같은 계열(인게임 문구로는 구분 불가)이다.
 */
const MAP_MODS = [
  { ids: ["explicit.stat_1852765051"], regex: "떨어", group: "기타", affix: "MapCorruptionBossCorruption", text: "고유 몬스터가 타락한 아이템을 떨어뜨림" },
  ...
  { ids: ["explicit.stat_1217583941"], regex: "적용", group: "기타", affix: "- 덧없음", text: "플레이어에게 적용되는 버프가 70% 더 빠르게 만료됨" },
  { ids: ["explicit.stat_272758639", "explicit.stat_3729221884"], regex: "막기", group: "기타", affix: "- 녹", text: "플레이어의 방어도 30% 감폭\n플레이어의 막기 확률 40% 감소" },
  { ids: ["explicit.stat_2312028586"], regex: "플레이어의.효", group: "기타", affix: "- 무기력", text: "플레이어의 효과 범위 25% 감폭" },
  ...
  { ids: ["explicit.stat_1890519597"], regex: "몬스터.피", group: "몬스터 강화", affix: "야만적인", text: "몬스터 피해 (22—25)% 증가" },
  ...
  { ids: ["explicit.stat_1840747977", "explicit.stat_3044826007"], regex: "동안", group: "몬스터 강화", affix: "모독적인", text: "몬스터가 물리 피해의 (31—35)%를 추가 카오스 피해로 획득\n몬스터가 명중 시 2초 동안 위축 유발" },
  { ids: ["explicit.stat_4154059009"], regex: "사술", group: "몬스터 강화", affix: "사술 방지", text: "몬스터가 사술 방지 보유" },
  { ids: ["explicit.stat_2887760183"], regex: "생명력의", group: "몬스터 강화", affix: "강해진", text: "몬스터가 최대 생명력의 (40—49)%를 추가 에너지 보호막 최대치로 획득" },
  { ids: ["explicit.stat_337935900"], regex: "치명타로", group: "몬스터 강화", affix: "- 강인함", text: "몬스터가 치명타로 받는 추가 피해 (36—40)% 감소" },
  ...
  { ids: ["explicit.stat_1588049749"], regex: "몬스터의.정", group: "몬스터 강화", affix: "- 수렁", text: "몬스터의 정확도 50% 증가" },
  { ids: ["explicit.stat_962720646"], regex: "방해", group: "몬스터 강화", affix: "- 저해", text: "몬스터의 주문 명중 시 이동 방해 유발" },
  { ids: ["explicit.stat_2138205941"], regex: "억제", group: "몬스터 강화", affix: "억제하는", rec: true, text: "몬스터의 주문 피해 억제 확률 +60%" },
  ...
  { ids: ["explicit.stat_365540634", "explicit.stat_1054098949"], regex: "저항.\\+", group: "몬스터 강화", affix: "저항하는", text: "몬스터의 카오스 저항 +25%\n몬스터의 원소 저항 +40%" },
  { ids: ["explicit.stat_1708461270"], regex: "몬스터의.효", group: "몬스터 강화", affix: "- 거인", text: "몬스터의 효과 범위 100% 증가" },
  ...
  { ids: ["explicit.stat_3667574329"], regex: "플레이어의.정", group: "방어 약화", affix: "- 비정밀함", rec: true, text: "플레이어의 정확도 25% 감폭" },
  { ids: ["explicit.stat_2588474575"], regex: "사로", group: "보스 강화", affix: "예속된", text: "고유 보스가 사로잡힘" },
  { ids: ["explicit.stat_124877078", "explicit.stat_2109106920"], regex: "주는", group: "보스 강화", affix: "대군주의", text: "고유 보스가 주는 피해 25% 증가\n고유 보스의 공격 및 시전 속도 30% 증가" },
  { ids: ["explicit.stat_1959158336", "explicit.stat_3040667106"], regex: "보스의.생", group: "보스 강화", affix: "거신의", text: "고유 보스의 생명력 35% 증가\n고유 보스의 효과 범위 70% 증가" },
  { ids: ["explicit.stat_799271621"], regex: "지역에.고", group: "보스 강화", affix: "이중", text: "지역에 고유 보스 2마리 등장" },
  ...
  { ids: ["explicit.stat_3561450806"], regex: "종류", group: "지역 구성", affix: "다양한", text: "지역에 등장하는 몬스터 종류 증가" },
  ...
  { ids: ["explicit.stat_1612402470"], regex: "정교", group: "지역 구성", affix: "MapCorruptionVaalVessel", text: "지역에 방어되는 정교한 바알 그릇 1개 추가 등장" },
  ...
  { ids: ["explicit.stat_3577222856"], regex: "훼손", group: "지역 구성", affix: "- 모독", text: "지역에 훼손된 지대 존재" },
  { ids: ["explicit.stat_2961018200"], regex: "흉물", group: "지역 구성", affix: "혐오스러운", text: "지역에 흉물 서식" },
  { ids: ["explicit.stat_3126771445"], regex: "몬스터.수", group: "지역 구성", affix: "적대자의", text: "희귀 몬스터 수 (20—30)% 증가" },
  ...
  { ids: ["explicit.stat_687813731"], regex: "시.인", group: "회복 방해", affix: "- 인내", text: "몬스터가 명중 시 인내 충전 획득" },
  { ids: ["explicit.stat_1140978125"], regex: "흡수", group: "회복 방해", affix: "- 응고", rec: true, text: "몬스터는 흡수 대상이 되지 않음" },
  { ids: ["explicit.stat_1910157106"], regex: "마나", group: "회복 방해", affix: "- 정체", rec: true, text: "플레이어가 생명력, 마나 또는 에너지 보호막 재생 불가" },
  ...
  { ids: ["explicit.stat_2549889921"], regex: "플라", group: "회복 방해", affix: "- 가뭄", rec: true, text: "플레이어의 플라스크 충전량 50% 감소" },
];
